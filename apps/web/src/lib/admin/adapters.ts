...
export function adaptEventSourceCandidates(src: BE): ParsedCandidate[] {
  ...
  return candidates.map((c, i) => ({
    ...
    imageAlt: (c.imageAlt as string) || null,
    imageCredit: (c.imageCredit as string) || null,
    imageSourceUrl: (c.imageSourceUrl as string) || null,
...
export function adaptEvent(event: BE): AdminEvent {
  ...
  return {
    ...
    imageAlt: (event.imageAlt as string) ?? null,
    imageCredit: (event.imageCredit as string) ?? null,
    imageSourceUrl: (event.imageSourceUrl as string) ?? null,

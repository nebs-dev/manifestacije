...
function InputGroupButton({
  ...
  return (
    <Button
      ...
      variant={variant}
      size={size as "xs" | "sm"}
      className={cn("flex items-center gap-2 text-sm shadow-none", className)}
      {...props}
    />
  )
}

      ...
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2.5 text-sm">
              <li>
                <Link href="/dogadjaji" className="text-ink-foreground/80 transition-colors hover:text-accent">
                  Svi događaji
                </Link>
              </li>
              <li>
                <Link href="/karta" className="text-ink-foreground/80 transition-colors hover:text-accent">
                  Karta
                </Link>
              </li>
              <li>
                <Link href="/#organizatori" className="text-ink-foreground/80 transition-colors hover:text-accent">
                  Dodaj event
                </Link>
              </li>
            </ul>

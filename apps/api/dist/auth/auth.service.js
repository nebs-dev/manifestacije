...
let AuthService = class AuthService {
    ...
    async register(dto) {
        ...
        const organizerSlug = await (0, slug_1.uniqueSlug)(organizerName, async (s) => !!(await this.prisma.organizer.findUnique({ where: { slug: s } })));
        ...
        const user = await this.prisma.user.create({
            data: { email: dto.email, passwordHash, name: dto.name, role: client_1.UserRole.ORGANIZER, organizerId: organizer.id }
        });

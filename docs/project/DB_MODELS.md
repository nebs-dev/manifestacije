...
| Category | `id`, `name`, `slug`, `parentId`, `parent`, `children`, `sortOrder`, `events`, `eventCats` | ▮▮▮ High | `apps/api/prisma/schema.prisma` |
| EventCategory | `eventId`, `categoryId`, `source`, `confidence`, `createdAt`, `event`, `category` | ▮▮▮ High | `apps/api/prisma/schema.prisma` |
| Event | `id`, `title`, `slug`, `description`, `status`, `organizerId`, `organizer`, `venueId`, `venue`, `cityName`, `cityId`, `city`, `countyId`, `county`, `regionId`, `region`, `categoryId`, `category`, `categories`, `startsAt`, `endsAt`, `isAllDay`, `isFree`, `priceText`, `ticketUrl`, `sourceUrl`, `imageUrl`, `address`, `lat`, `lng`, `sourceType`, `extractionConfidence`, `isFeatured`, `publishedAt`, `sources`, `duplicatesA`, `duplicatesB`, `createdAt`, `updatedAt` | ▮▮▮ High | `apps/api/prisma/schema.prisma` |

...
| --- | --- | --- | --- |
| Is billing intentionally out of scope? | Open question | Medium | `apps/api/package.json`<br>`apps/web/package.json`<br>`apps/web/v0-import/admin-ui-import/package.json`<br>`apps/web/v0-import/event-discovery-platform/package.json`<br>`package.json` |
